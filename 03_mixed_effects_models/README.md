...
| `glmm_diagnostics.ipynb` | Residual diagnostics with `DHARMa`; overdispersion, zero-inflation, and model fit checks |
| `model_selection_aic.ipynb` | AIC/AICc-based model selection and multi-model inference with `AICcmodavg` and `MuMIn` |
